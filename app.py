...
st.markdown('''
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, #d6f2bf, #b4b7b8);
        }
    </style>
...
# Subtitle
st.markdown('''
    <div style='text-align: center; font-size: 22px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color:#171515;'>
...
ax.set_title(f"EV Adoption Forecast - {county}", fontsize=14)
ax.set_xlabel("Date")
...
st.markdown("Prepared by Harsha vaka- id : STU6849be57c62f91749663319")